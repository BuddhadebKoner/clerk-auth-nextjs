...
export default function SignIn() {
   ...
   const handleEmailSignIn = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
         ...
         setError(err.errors ? err.errors[0].message : "Something went wrong. Please try again.");
      }
   };
   ...
   const handleOAuthSignIn = async (strategy: "oauth_google" | "oauth_github") => {
      ...
      try {
         ...
         setError(err.errors ? err.errors[0].message : "OAuth sign-in failed. Please try again.");
      }
   };
